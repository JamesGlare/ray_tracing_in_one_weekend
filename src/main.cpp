...
hittable_list three_spheres() {
    ...
    auto material_right = make_shared<dielectric>(1.7);
    auto material_front = make_shared<dielectric>(1.3);
    
    world.add(make_shared<sphere>(point3(0.0, -100.5, -1.0), 100.0, material_ground));
    world.add(make_shared<sphere>(point3(0.0, 0.0, -1.0), 0.5, material_center));
    world.add(make_shared<sphere>(point3(-0.6, 0.5, -1.4), 0.25, material_left));
    world.add(make_shared<sphere>(point3(0.8, 0.3, -0.5), 0.25, material_right));
    world.add(make_shared<sphere>(point3(-0.7, 0.2, -0.5), 0.25, material_front));
    return world;
}
